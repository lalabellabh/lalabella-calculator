...
(function () {
  ...
  function drawSettings() {
    ...
    else if (T.isNativeDark()) h += '<div class="lbset-note">This page keeps its own colours (it is already dark, or it is a card/label designer). Other pages follow your choice.</div>';
